...
import { parseAc3Descriptor, parseEc3Descriptor } from './dolby-audio.js';
...
/**
 * A comprehensive mapping of TS descriptors to tooltips.
 */
    ...
    while (offset < view.byteLength) {
        ...
        switch (descriptor_tag) {
            ...
            case 0x38:
                ...
                break;
            case 0x63: {
                const res = parseExtensionDescriptor(
                    payloadView,
                    payloadOffset
                );
                name = res.name;
            ...
            case 0x6a: // DVB AC-3
            case 0x81: // ATSC AC-3
                name = 'AC-3 Audio Descriptor';
                details = parseAc3Descriptor(payloadView, payloadOffset);
                break;
            case 0x7a: // DVB Enhanced AC-3
            case 0xcc: // ATSC Enhanced AC-3
                name = 'EC-3 (Dolby Digital Plus) Descriptor';
                details = parseEc3Descriptor(payloadView, payloadOffset);
                break;
            default:
                details = {
                    data: {
