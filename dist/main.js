            ...
            function element(matchRoot) {
                ...
                if (parsingState.options.strictMode) {
                    ...
                    if (parsingState.xml.startsWith(closingTag)) {
                        parsingState.xml = parsingState.xml.slice(
                            closingTag.length
                        );
                    } else {
                        throw new ParsingError(
            ...
            function cdata() {
                if (parsingState.xml.startsWith('<![CDATA[')) {
                    ...
                    if (endPositionStart > -1) {
                        ...
                        const node = {
                            type: 'CDATA',
                            content: parsingState.xml.substring(
                                0,
                                endPositionFinish
                            ),
                        };
                        parsingState.xml =
                            parsingState.xml.slice(endPositionFinish);
                        return {
                            excluded:
                                parsingState.options.filter(node) === false,
                            node,
    ...
    var require_cjs2 = __commonJS({
        'node_modules/xml-formatter/dist/cjs/index.js'(exports, module) {
            ...
            function isPathMatchingIgnoredPaths(path, ignoredPaths) {
                ...
                return (
                    ignoredPaths.includes(pathLastPart) ||
                    ignoredPaths.includes(fullPath)
                );
            }
            function processElementNode(node, state, preserveSpace) {
                ...
                if (
                    node.children === null ||
                    (state.options.forceSelfClosingEmptyTag &&
                    ...
                    if (!nodePreserveSpace && state.options.collapseContent) {
                        ...
                        if (
                            containsTextNodes &&
                            (!containsNonTextNodes ||
                                !containsTextNodesWithLineBreaks)
                        ) {
                    ...
                    nodeChildren.forEach(function (child) {
                        processNode(
                            child,
                            state,
                            preserveSpace || nodePreserveSpace
                        );
                    });
                    state.level--;
            ...
            function formatXml(xml, options = {}) {
                ...
                try {
                    ...
                    if (parsedXml.declaration) {
                        processProcessingIntruction(
                            parsedXml.declaration,
                            state
                        );
                    }
...
\f\r"'\`<>=]|("|')|))|$)`,
    ...
    var y =
        (t3) =>
        (i3, ...s2) => ({ _$litType$: t3, strings: i3, values: s2 });
    var x = y(1);
    var b = y(2);
    var w = y(3);
    ...
    var V = (t3, i3) => {
        ...
        for (let i4 = 0; i4 < s2; i4++) {
            ...
            for (
                ;
                y2 < s3.length &&
                ((c2.lastIndex = y2), (u2 = c2.exec(s3)), null !== u2);
            ...
            l2 +=
                c2 === f
                    ...
                    : d2 >= 0
                      ? (o3.push(a2),
                        s3.slice(0, d2) + e + s3.slice(d2) + h + x2)
                      : s3 + h + (-2 === d2 ? i4 : x2);
        }
        return [
            P(
    ...
    var N = class _N {
        constructor({ strings: t3, _$litType$: s2 }, n2) {
            ...
            const u2 = t3.length - 1,
                ...
                [f2, v2] = V(t3, s2);
            if (
                ((this.el = _N.createElement(f2, n2)),
            ...
            for (; null !== (r2 = C.nextNode()) && d2.length < u2; ) {
                if (1 === r2.nodeType) {
                    if (r2.hasAttributes())
                        for (const t4 of r2.getAttributeNames())
                            if (t4.endsWith(e)) {
                                ...
                                t4.startsWith(h) &&
                                    (d2.push({ type: 6, index: c2 }),
                                    r2.removeAttribute(t4));
                    if ($.test(r2.tagName)) {
                        const t4 = r2.textContent.split(h),
                            s3 = t4.length - 1;
                        if (s3 > 0) {
                    ...
                    if (r2.data === o) d2.push({ type: 2, index: c2 });
                    else {
                        let t4 = -1;
                        for (; -1 !== (t4 = r2.data.indexOf(h, t4 + 1)); )
                            (d2.push({ type: 7, index: c2 }),
                                (t4 += h.length - 1));
                    }
                c2++;
            }
    ...
    function S(t3, i3, s2 = t3, e4) {
        ...
        return (
            h2?.constructor !== o3 &&
                ...
                void 0 === o3
                    ? (h2 = void 0)
                    : ((h2 = new o3(t3)), h2._$AT(t3, s2, e4)),
                void 0 !== e4 ? ((s2._$Co ??= [])[e4] = h2) : (s2._$Cl = h2)),
            void 0 !== h2 && (i3 = S(t3, h2._$AS(t3, i3.values), h2, e4)),
            i3
        );
    }
    var M = class {
        ...
        u(t3) {
            const {
                ...
                e4 = (t3?.creationScope ?? r).importNode(i3, true);
            C.currentNode = e4;
            let h2 = C.nextNode(),
                o3 = 0,
                n2 = 0,
            ...
            for (; void 0 !== l2; ) {
                if (o3 === l2.index) {
                    let i4;
                    (2 === l2.type
                        ? (i4 = new R(h2, h2.nextSibling, this, t3))
                        : 1 === l2.type
                          ? (i4 = new l2.ctor(
                                h2,
                                l2.name,
        ...
        p(t3) {
            ...
            for (const s2 of this._$AV)
                (void 0 !== s2 &&
                    (void 0 !== s2.strings
                        ? (s2._$AI(t3, s2, i3), (i3 += s2.strings.length - 2))
                        : s2._$AI(t3[i3])),
                    i3++);
        }
    };
    var R = class _R {
        ...
        get parentNode() {
            ...
            const i3 = this._$AM;
            return (
                void 0 !== i3 && 11 === t3?.nodeType && (t3 = i3.parentNode),
                t3
            );
        }
        get startNode() {
        ...
        _(t3) {
            (this._$AH !== E && c(this._$AH)
                ...
                : this.T(r.createTextNode(t3)),
                (this._$AH = t3));
        }
        $(t3) {
            const { values: i3, _$litType$: s2 } = t3,
                e4 =
                    'number' == typeof s2
                        ? this._$AC(t3)
                        : (void 0 === s2.el &&
                              (s2.el = N.createElement(
                                  P(s2.h, s2.h[0]),
                                  this.options
                              )),
                          s2);
        ...
        k(t3) {
            ...
            for (const h2 of t3)
                (e4 === i3.length
                    ...
                    e4++);
            e4 < i3.length &&
                (this._$AR(s2 && s2._$AB.nextSibling, e4), (i3.length = e4));
        }
    ...
    var k = class {
        ...
        _$AI(t3, i3 = this, s2, e4) {
            ...
            if (void 0 === h2)
                ((t3 = S(this, t3, i3, 0)),
                    (o3 = !c(t3) || (t3 !== this._$AH && t3 !== T)),
                    o3 && (this._$AH = t3));
            else {
                const e5 = t3;
                let n2, r2;
                for (t3 = h2[0], n2 = 0; n2 < h2.length - 1; n2++)
                    ((r2 = S(this, e5[s2 + n2], i3, n2)),
                        r2 === T && (r2 = this._$AH[n2]),
                        (o3 ||= !c(r2) || r2 !== this._$AH[n2]),
                        r2 === E
                            ? (t3 = E)
                            : t3 !== E && (t3 += (r2 ?? '') + h2[n2 + 1]),
                        (this._$AH[n2] = r2));
    ...
    var L = class extends k {
        ...
        _$AI(t3, i3 = this) {
            ...
            const s2 = this._$AH,
                ...
                h2 = t3 !== E && (s2 === E || e4);
            (e4 && this.element.removeEventListener(this.name, this, s2),
                h2 && this.element.addEventListener(this.name, this, t3),
                (this._$AH = t3));
        }
        handleEvent(t3) {
    ...
    var B = (t3, i3, s2) => {
        ...
        if (void 0 === h2) {
            ...
            e4._$litPart$ = h2 = new R(
                i3.insertBefore(l(), t4),
                t4,
                void 0,
                s2 ?? {}
            );
    ...
    function getGlobalSummaryTemplate(mpd) {
        ...
        const resolutions = [
            ...new Set(
                allVideoReps.map((r2) => {
                    ...
                    const width =
                        r2.getAttribute('width') || as.getAttribute('width');
                    const height =
                        r2.getAttribute('height') || as.getAttribute('height');
        ...
        const videoCodecs = [
            ...new Set(
                allVideoReps.map(
                    (r2) =>
                        r2.getAttribute('codecs') ||
                        r2.closest('AdaptationSet').getAttribute('codecs')
                )
            ),
        ].filter(Boolean);
        ...
        ${
            videoSets.length > 0
                ? x` <h3 class="text-xl font-bold mt-6 mb-4">Video Details</h3>
                  <dl>
                      ${rowTemplate(
                          'Bitrate Range',
                          bandwidths.length > 0
        ...
        ${
            audioSets.length > 0
                ? x` <h3 class="text-xl font-bold mt-6 mb-4">Audio Details</h3>
                  <dl>
                      ${rowTemplate(
                          'Languages',
...
`;
    ...
    var abrLadderTemplate = (period) => {
        ...
        return videoSets.map((as) => {
            const reps = Array.from(as.querySelectorAll('Representation')).sort(
                (a2, b2) =>
                    parseInt(a2.getAttribute('bandwidth')) -
                    parseInt(b2.getAttribute('bandwidth'))
            );
            ...
            const repTemplate = reps.map((rep) => {
                ...
                const width =
                    rep.getAttribute('width') || as.getAttribute('width');
                const height =
    ...
    var staticTimelineTemplate = (mpd) => {
        ...
        const totalDuration =
            parseDuration(mpd.getAttribute('mediaPresentationDuration')) ||
            lastPeriodEnd;
        if (totalDuration === 0)
        ...
        const gridTemplateColumns = periodData
            .map((p2) => `${(p2.duration / totalDuration) * 100}%`)
            .join(' ');
    ...
    var e2 =
        (t3) =>
        (...e4) => ({ _$litDirective$: t3, values: e4 });
    var i2 = class {
        constructor(t3) {}
        get _$AU() {
            return this._$AM._$AU;
    ...
    var e3 = class extends i2 {
        constructor(i3) {
            if ((super(i3), (this.it = E), i3.type !== t2.CHILD))
                throw Error(
    ...
    var features = [
        ...
        },
        {
            ...
            isoRef: 'Clause 8.12',
            check: (mpd) => {
                const p2 = (mpd.getAttribute('profiles') || '').includes(
                    'cmaf'
                );
                const b2 = Array.from(
                    mpd.querySelectorAll(
        ...
        // --- Live & Dynamic Features ---
        {
            ...
            check: (mpd) => {
                ...
                if (hasChunkHint)
                    details.push('Chunked transfer hint present.');
                return { used: true, details: details.join(' ') };
            },
        },
        {
            ...
            check: (mpd) => {
                ...
                return {
                    used: !!p2,
                    details: p2
                        ? `Patch location: <code>${p2.textContent.trim()}</code>`
        ...
        // --- Advanced Content Features ---
        {
            ...
            check: (mpd) => {
                ...
                return {
                    ...
                    details:
                        d2.length > 0
                            ? `${d2.length} dependent Representation(s) found.`
        ...
        },
        {
            ...
            isoRef: 'Clause 5.3.6',
            check: (mpd) => {
                const s2 = mpd.querySelector(
                    'SubRepresentation[maxPlayoutRate]'
                );
                const r2 = mpd.querySelector(
                    'AdaptationSet Role[value="trick"]'
                );
                if (!s2 && !r2)
                    return {
                        used: false,
            ...
            check: (mpd) => {
                ...
                const roles = [
                    ...new Set(
                        r2.map(
                            (role) =>
                                `<code>${role.getAttribute('value')}</code>`
                        )
                    ),
                ];
                return {
    ...
    var featureRowTemplate = (feature, mpd) => {
        ...
        const statusIcon = result.used
            ? x`<span class="text-green-400 font-bold text-lg" title="Used"
              >✔</span
          >`
...
`;
    function getFeaturesAnalysisTemplate(mpd) {
        ...
        ${Object.entries(groupedFeatures).map(([category, features2]) =>
            categoryTemplate2(category, features2, mpd)
        )}
            ...
            switch (node.nodeType) {
                case Node.ELEMENT_NODE: {
                    ...
                    if (meaningfulChildren.length > 0) {
                        return x`${indent}${getTagHTML(el.tagName)}${Array.from(el.attributes).map((a2) => x` ${getAttributeHTML(el.tagName, a2)}`)}&gt;\n${childNodes.map((c2) => preformatted(c2, depth + 1))}${indent}${getTagHTML(`/${el.tagName}`)}&gt;\n`;
                    } else {
                        return x`${indent}${getTagHTML(el.tagName)}${Array.from(el.attributes).map((a2) => x` ${getAttributeHTML(el.tagName, a2)}`)} /&gt;\n`;
                    }
                }
                case Node.TEXT_NODE: {
                    return node.textContent.trim()
                        ? x`${indent}<span class="interactive-xml-text">${escapeHtml(node.textContent.trim())}</span>\n`
                        : E;
                }
                case Node.COMMENT_NODE: {
                    return x`${indent}<span class="interactive-xml-comment">&lt;!--${escapeHtml(node.textContent)}--&gt;</span>\n`;
                }
                default:
                    return E;
            }
        };
        return x`<div class="interactive-mpd-container"><pre><code>${preformatted(mpd)}</code></pre></div>`;
    }
    ...
    function parseTsSegment(buffer) {
        ...
        for (
            ...
            if (dataView.getUint8(offset) !== SYNC_BYTE) {
                ...
                for (
                    let i3 = offset + 1;
                    i3 < offset + TS_PACKET_SIZE * 2 && i3 < buffer.byteLength;
                    i3++
                ) {
            ...
            if (
                ...
                const expectedCounter =
                    (pidData.lastContinuityCounter + 1) % 16;
            ...
            if (
                ...
                if (pid === 0) {
                    ...
                    const tableOffset = payloadOffset + pointerField + 1;
                    const sectionLength =
                        dataView.getUint16(tableOffset + 1) & 4095;
                    const programInfoLength =
                        dataView.getUint16(tableOffset + 10) & 4095;
                    ...
                    while (
                        ...
                        const elementaryPid =
                            dataView.getUint16(streamInfoOffset + 1) & 8191;
                        const esInfoLength =
                            dataView.getUint16(streamInfoOffset + 3) & 4095;
                    ...
                    dataView.getUint32(payloadOffset) >>> 8 === 1
                ) {
                    const ptsDtsFlags =
                        dataView.getUint8(payloadOffset + 7) >> 6;
    ...
    var tsAnalysisTemplate = (analysis) => {
        ...
        ${
            analysis.summary.errors.length > 0
                ? x`<div class="analysis-summary fail">
                        ...
                        (pidInfo) => x`
                            <tr>
                                ...
                                <td class="field-value">
                                    ${pidInfo.continuityErrors > 0 ? x`<span class="warn">CC Errors: ${pidInfo.continuityErrors}</span>` : ''}
                                    ${pidInfo.pts.length > 0 ? x`<span>PTS Count: ${pidInfo.pts.length}</span>` : ''}
                                </td>
                            </tr>
                        `
                    )}
    ...
    var isoBoxTemplate = (box) => {
        ...
        const childrenTemplate =
            box.children.length > 0
                ? x`<ul>${box.children.map((child) => x`<li>${isoBoxTemplate(child)}</li>`)}</ul>`
                : '';
        ...
        try {
            ...
            switch (box.type) {
                ...
                case 'mdhd': {
                    ...
                    box.details['duration'] =
                        version === 1
                            ? Number(view.getBigUint64(tsOffset + 4))
                            : view.getUint32(tsOffset + 4);
                ...
                case 'vmhd': {
                    ...
                    box.details['opcolor'] =
                        `R:${view.getUint16(14)}, G:${view.getUint16(16)}, B:${view.getUint16(18)}`;
                    break;
                }
                case 'stsd': {
                    box.details['version'] = version;
                ...
                case 'stsc': {
                    ...
                    if (box.details['entry_count'] > 0) {
                        ...
                        box.details['sample_description_index_1'] =
                            view.getUint32(24);
                    }
                    break;
                }
                ...
                case 'elst': {
                    ...
                    if (entry_count > 0) {
                        ...
                        if (version === 1) {
                            ...
                            box.details['segment_duration_1'] =
                                view.getUint32(entryOffset);
                ...
                case 'trex': {
                    ...
                    box.details['default_sample_description_index'] =
                        view.getUint32(16);
                    ...
                    box.details['default_sample_flags'] =
                        `0x${view.getUint32(28).toString(16)}`;
                    break;
                }
                case 'sidx': {
                    box.details['version'] = version;
                    ...
                    if (version === 1) {
                        ...
                        box.details['earliest_presentation_time'] =
                    ...
                    if (ref_count > 0) {
                        ...
                        box.details['reference_type_1'] =
                            ref_type === 1 ? 'sidx' : 'media';
                        box.details['referenced_size_1'] =
                            view.getUint32(offset) & 2147483647;
                ...
                case 'tfhd': {
                    ...
                    if (flags & 2) {
                        box.details['sample_description_index'] =
                            view.getUint32(offset);
                        offset += 4;
                    }
                    if (flags & 8) {
                        box.details['default_sample_duration'] =
                            view.getUint32(offset);
                        offset += 4;
                    }
                    if (flags & 16) {
                        box.details['default_sample_size'] =
                            view.getUint32(offset);
                        offset += 4;
                    }
                    if (flags & 32) {
                        box.details['default_sample_flags'] =
                            `0x${view.getUint32(offset).toString(16)}`;
                    }
                    break;
                }
                case 'tfdt': {
                    box.details['version'] = version;
                    box.details['baseMediaDecodeTime'] =
                        version === 1
                            ? Number(view.getBigUint64(12))
                            : view.getUint32(12);
                    break;
                }
                case 'trun': {
                    ...
                    box.details['samples'] =
                        x`<div class="sample-data"><pre>${samples.join('\n')}${
                            sample_count > 10
                                ? `
... (${sample_count - 10} more)`
                                : ''
                        }</pre></div>`;
                    break;
                }
                case 'mdat': {
                    box.details['info'] =
                        'Contains raw media data for samples.';
                    break;
                }
            }
        } catch (_e) {
    ...
    function dispatchAndRenderSegmentAnalysis(e4, buffer) {
        if (!buffer) {
            B(
                x`<p class="fail">Segment buffer is not available for analysis.</p>`,
        ...
        const rep = activeStream.mpd.querySelector(
        ...
        try {
            ...
            B(
                x`<p class="fail">Could not parse segment buffer: ${err.message}.</p>`,
                dom.modalContentArea
            );
        }
    }
    ...
    var segmentRowTemplate = (seg) => {
        ...
        const segmentTiming =
            seg.type === 'Media'
                ? x`${(seg.time / seg.timescale).toFixed(2)}s (+${(seg.duration / seg.timescale).toFixed(2)}s)`
                : 'N/A';
        return x` <tr
    ...
    async function handleFilter() {
        ...
        const toValue =
            toInput.value !== '' ? parseFloat(toInput.value) : Infinity;
        if (isNaN(fromValue) || isNaN(toValue)) {
            B(
                x`<p class="warn">Please enter valid numbers for the filter range.</p>`,
                contentArea
            );
            return;
        }
        ...
        const filteredSegmentsByRep = getFilteredSegments(
            fromValue,
            toValue,
            type
        );
        ...
        if (segmentsToFetch.length === 0) {
            B(
                x`<p class="warn">No segments found matching the specified filter.</p>`,
                contentArea
            );
            return;
        }
    ...
    function parseAllSegmentUrls(mpd, baseUrl) {
        ...
        mpd.querySelectorAll('Representation').forEach((rep) => {
            ...
            const timescale = parseInt(
                template.getAttribute('timescale') || '1'
            );
            const initTemplate = template.getAttribute('initialization');
            if (initTemplate) {
                const url = initTemplate.replace(
                    /\$RepresentationID\$/g,
                    repId
                );
            ...
            if (mediaTemplate && timeline) {
                ...
                timeline.querySelectorAll('S').forEach((s2) => {
                    const t3 = s2.hasAttribute('t')
                        ? parseInt(s2.getAttribute('t'))
                        : currentTime;
                            ...
                            .replace(
                                ...
                                (match, padding) => {
                                    const width = padding
                                        ...
                                        : 1;
                                    return String(segmentNumber).padStart(
                                        width,
                                        '0'
                                    );
                                }
    ...
    function updateSegmentFreshness() {
        ...
        if (
            !activeStream ||
            activeStream.mpd.getAttribute('type') !== 'dynamic'
        )
            return;
        ...
        'Video Details': [
            ...
            },
            {
                ...
                accessor: (mpd) => {
                    ...
                    return b2.length
                        ? `${formatBitrate2(Math.min(...b2))} - ${formatBitrate2(Math.max(...b2))}`
                        : 'N/A';
                },
            },
            {
                    ...
                    const res = [
                        ...new Set(
                            Array.from(
                                ...
                                const as = r2.closest('AdaptationSet');
                                const width =
                                    r2.getAttribute('width') ||
                                    as.getAttribute('width');
                                const height =
                                    r2.getAttribute('height') ||
...
`;
                ...
                try {
                    ...
                    if (
                        ...
                        for (const node of nodesToInsert) {
                            const importedNode =
                                rootElement.ownerDocument.importNode(
                                    node,
                                    true
                                );
                ...
                if (!component.removed) {
                    if (!component.added && this.useLongestToken) {
                        ...
                        value = value.map(function (value2, i3) {
                            ...
                            return oldValue.length > value2.length
                                ? oldValue
                                : value2;
                        });
    ...
    function startMpdUpdatePolling(stream) {
        ...
        let originalMpdString = new XMLSerializer().serializeToString(
            stream.mpd
        );
    ...
    var mpdUpdatesTemplate = (stream) => {
        ...
        if (updateCount === 0) {
            ...
            const formattedInitialMpd = (0, import_xml_formatter2.default)(
                initialMpdString,
                {
                    indentation: '  ',
                    lineSeparator: '\n',
            ...
            <div class="diff-container">
                <span>${escapeHtml3(formattedInitialMpd)}</span>
            </div>`;
        } else {
    ...
    function handleTabClick(e4) {
        ...
        dom.tabs
            ...
            .forEach((t3) => t3.classList.remove('tab-active'));
