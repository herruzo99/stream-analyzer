...
const isoBoxTemplate = (box) => {
    ...
    const headerTemplate = html` <div class="box-header">
        <span
            class="type"
    ...
    const detailsTemplate =
        Object.keys(box.details).length > 0
            ? html` <table class="box-details-table">
                  <tbody>
...
const essentialDataTemplate = (boxes) => {
    ...
    if (moof) {
        ...
        return html` <div class="segment-essential-data">
            <div>
    ...
    try {
        ...
        switch (box.type) {
            ...
            case 'trun': {
                ...
                box.details['samples'] = html`<div class="sample-data">
                    <pre>
${samples.join('\n')}${sample_count > 10
