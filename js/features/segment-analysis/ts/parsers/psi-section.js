// A generic parser for the Program Specific Information (PSI) section format.
// It handles the common structure including table_id, section_length,
// version_number, and CRC_32, returning the payload for specific
// table parsers (PAT, PMT).

// CRC-32 table for the polynomial 0x04C11DB7, standard in MPEG-2.
...
/**
 * Calculates the MPEG-2 CRC-32 for a given DataView slice.
 * @param {DataView} view - A DataView of the data to be checksummed.
 * @returns {number} The calculated 32-bit CRC value.
 */
 ...
 * @returns {{header: object, payload: DataView, crc: number, isValid: boolean}} Parsed data.
 */
export function parsePsiSection(view) {
    ...
    if (section_syntax_indicator === 1) {
        ...
        header.version_number = (view.getUint8(5) >> 1) & 0x1f;
        header.current_next_indicator = view.getUint8(5) & 0x01;
