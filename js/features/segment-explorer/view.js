...
let allSegmentsByRep = {}; // Caches the full list of segments for the current manifest
...
const segmentRowTemplate = (seg) => {
    ...
    const viewRawHandler = (e) => {
        ...
        const targetTab = /** @type {HTMLButtonElement} */ (
...
export function initializeSegmentExplorer(container, manifest, baseUrl) {
...
function updateSegmentFreshness() {
    ...
    const availabilityStartTime =
        activeStream.manifest.availabilityStartTime?.getTime();
